...
SELECT pgp_sym_decrypt(author_biography::bytea, 'hidden') AS description
FROM author, book
WHERE pgp_sym_decrypt(author_biography::bytea, 'hidden') LIKE '%Lorem%'
AND pgp_sym_decrypt(author_biography::bytea, 'hidden') IN (SELECT pgp_sym_decrypt(author_biography::bytea, 'hidden'))
AND pgp_sym_decrypt(author_biography::bytea, 'hidden') IN (SELECT pgp_sym_decrypt(author_biography::bytea, 'hidden'))
AND pgp_sym_decrypt(author_biography::bytea, 'hidden') IN (SELECT pgp_sym_decrypt(author_biography::bytea, 'hidden'))
AND pgp_sym_decrypt(author_biography::bytea, 'hidden') IN (SELECT pgp_sym_decrypt(author_biography::bytea, 'hidden'))
AND pgp_sym_decrypt(author_biography::bytea, 'hidden') IN (SELECT pgp_sym_decrypt(author_biography::bytea, 'hidden'))
